      ...
      try {
        ...
        for (const semId of semesters) {
          try {
            ...
            console.log(`Students for BBA, semester ${semId}:`, sortedStudents);
          } catch (err) {
        ...
        setError(`Failed to load BBA students data: ${err.message}`);
        setLoading(false);
      }
    };
    ...
    >
      <div className="w-full max-w-5xl bg-white bg-opacity-90 shadow-2xl rounded-lg p-8">
        <h2 className="text-3xl font-bold text-center mb-6 text-gray-700">
          BBA Students by Semester with Percentages
        </h2>
          ...
          <div className="h-96 mb-6">
            <Bar
              ...
              options={{
                ...
                plugins: {
                  legend: { position: "top" },
                  title: { display: true, text: "BBA Students Percentages by Semester" },
                  tooltip: {
                    callbacks: {
        ...
        <div className="mt-6">
          <h3 className="text-xl font-semibold mb-2">BBA Students Details</h3>
...
export default BBAToppersGraph;