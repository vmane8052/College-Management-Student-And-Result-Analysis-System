      ...
      try {
        ...
        for (const semId of semesters) {
          try {
            ...
            console.log(`Pass/Fail stats for BCA, semester ${semId}:`, passFailStats[semId]);
          } catch (err) {
        ...
        setError(`Failed to load BCA pass/fail data: ${err.message}`);
        setLoading(false);
      }
    };
    ...
    >
      <div className="w-full max-w-5xl bg-white bg-opacity-90 shadow-2xl rounded-lg p-8">
        <h2 className="text-3xl font-bold text-center mb-6 text-gray-700">
          BCA Pass/Fail Distribution by Semester
        </h2>
...
export default BCAPassFailPieChart;