      ...
      try {
        ...
        for (const semId of semesters) {
          try {
            ...
            console.log(`Pass/Fail stats for MCA, semester ${semId}:`, passFailStats[semId]);
          } catch (err) {
        ...
        setError(`Failed to load MCA pass/fail data: ${err.message}`);
        setLoading(false);
      }
    };
    ...
    >
      <div className="w-full max-w-5xl bg-white bg-opacity-90 shadow-2xl rounded-lg p-8">
        <h2 className="text-3xl font-bold text-center mb-6 text-gray-700">
          MCA Pass/Fail Distribution by Semester
        </h2>
...
export default MCAPassFailPieChart;